...
class Login(views.APIView):
    ...
    def post(self, request):
        ...
        if user.bu_status != Status.ACTIVE.value:
            return Response({'code': Code.INACTIVE_USER.value, 'message': Code.INACTIVE_USER.name})
...
class CheckValidKey(views.APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({'code': Code.IMPROPER_PARAMETERS.value, 'message': Code.IMPROPER_PARAMETERS.name})
...
class CheckRecaptcha(views.APIView):
    ...
    def post(self, request):
        ...
        if response.status_code == 200:
            ...
            data = {'code': Code.IMPROPER_PARAMETERS.value, 'message': Code.IMPROPER_PARAMETERS.name}
